...
func TestAIServiceRecommendStructured(t *testing.T) {
	...
	svc := service.NewAIServiceWithClient(client)
	service.SetAIServiceBaseURLForTest(svc, "http://ai.test")
	out, err := svc.RecommendStructured(&service.AIRecommendContext{
...
func TestAIServiceRecommendStructuredEmptyChoices(t *testing.T) {
	...
	svc := service.NewAIServiceWithClient(client)
	service.SetAIServiceBaseURLForTest(svc, "http://ai.test")
	_, err := svc.RecommendStructured(&service.AIRecommendContext{}, 1)
	if err == nil {

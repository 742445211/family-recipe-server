...
type DailyOrder struct {
	...
	FamilyID  uint64         `gorm:"not null;index:idx_family_date_meal" json:"family_id"`
	Date      string         `gorm:"type:date;not null;index:idx_family_date_meal" json:"date"`
	MealType  string         `gorm:"size:20;not null;default:dinner;index:idx_family_date_meal" json:"meal_type"` // breakfast/lunch/dinner
